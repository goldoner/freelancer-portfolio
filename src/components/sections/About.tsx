...
const highlights = [
  ...
  {
    icon: <Languages size={20} className="text-purple-400" />,
    label: "Languages",
    value: "DE · EN · RU",
  },
];
  ...
  return (
    <section id="about" className="bg-zinc-950 py-24 px-4">
      <div className="max-w-5xl mx-auto" ref={ref}>
        ...
        >
          <span className="text-sm font-semibold tracking-widest text-purple-400 uppercase">About</span>
          <h2 className="mt-2 text-4xl font-bold text-white">The story behind the engineer</h2>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          >
            <p>
              ...
              <span className="text-white">University of Salzburg</span>, where I studied
            ...
            <p>
              ...
              source. From there I joined <span className="text-white">GridData</span> in
              Germany, designing CI/CD pipelines and data migration tools before landing at{" "}
              <span className="text-white">Porsche Informatik</span> in Vienna — one of
            ...
            <p>
              ...
              <span className="text-white">Aleksandr Grek e.U.</span> in Austria. I work with
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="text-lg font-semibold text-white mb-6">What sets me apart</h3>
            {usps.map((usp, i) => (
              <motion.div
                key={usp.title}
                ...
                className="rounded-xl border border-zinc-800 bg-zinc-900 p-5 hover:border-purple-500/40 transition-colors duration-300"
              >
                <div className="flex items-center gap-2 mb-2">
                  <span className="h-1.5 w-1.5 rounded-full bg-purple-500" />
                  <h4 className="font-semibold text-white text-sm">{usp.title}</h4>
                </div>
                <p className="text-sm text-zinc-400 leading-relaxed">{usp.desc}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
