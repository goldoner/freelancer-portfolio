...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 isolate flex flex-col items-center text-center px-4 max-w-4xl mx-auto">
        {/* Profile image */}
        <motion.div
        ...
        >
          <div className="relative h-28 w-28 rounded-full overflow-hidden ring-2 ring-purple-500/40 ring-offset-2 ring-offset-black">
            <Image
          ...
          <span className="absolute bottom-1 right-1 h-4 w-4 rounded-full bg-green-500 ring-2 ring-black" />
        </motion.div>
        ...
        <div className="flex items-baseline justify-center text-2xl sm:text-3xl md:text-5xl font-bold mb-6 max-w-full overflow-hidden">
          <span className="text-zinc-400 mr-3">Senior</span>
        ...
        >
          ...
          <span className="text-white font-medium">Porsche Informatik</span> engineer,
          now helping DACH and international clients ship faster with{" "}
          <span className="text-purple-400 whitespace-nowrap">Java · Spring Boot · TypeScript</span>.
        </motion.p>
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full border border-zinc-700 hover:border-zinc-500 bg-zinc-900 hover:bg-zinc-800 text-white font-semibold px-6 py-3 transition-all duration-200"
          >
            <GithubIcon size={18} />
            GitHub
          </a>
